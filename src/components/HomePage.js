...
const HomePage = () => {
    return (
        <div >
            <div className="w-[100vw] h[90vh] overflow-x-hidden ">
                <div className="w-[100vw] h-[90vh] bg-black lg:pl-12 rounded-br-full flex lg:flex-row md:flex-row flex-col justify-between overflow-hidden"
                ...
                >
                    ...
                    <div className="lg:w-[60vw] md:w-[60vw] w-[100vw] h-[90vh] rounded-br-full overflow-hidden flex justify-center">
                        <img src='https://wallpaperaccess.com/full/2602598.jpg' className='rotate-30  lg:w-[80vw] md:w-[70vw] w-[100vw]' />
                    </div>
                </div>
            </div>
