    ...
    return (
        <div className="flex flex-col w-[100vw] lg:h-[85vh]  bg-black items-center lg:justify-between md:justify-between justify-center py-[6vh]">
            ...
            <div className="lg:pl-0 md:pl-0 pl-[3vw] border-white lg:flex md:flex grid grid-cols-2 gap-1 flex-row lg:w-[100vw] md:w-[100vw] w-[94vw]">
                ...
                <div className="bg-slate-100 rounded-xl px-4 py-8 lg:w-[17.5vw] max-h-[400px] md:w-[17.5vw] w-[40vw] lg:mr-12 md:mr-10 lg:h-[45vh]">
                    <Rating name="half-rating-read" defaultValue={5} precision={0.5} readOnly />
                ...
                <div className="bg-slate-100 rounded-xl px-4 py-8 lg:w-[17.5vw] md:w-[17.5vw] lg:mt-0 md:mt-0 mt-4  w-[40vw] lg:mr-12 md:mr-10 mr-3 max-h-[400px] lg:h-[62.5vh] md:h-[60vh]">
